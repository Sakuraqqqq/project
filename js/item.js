    ...
    return {
        ...
        event: function () {
            ...
            this.$showImage.onmousemove = function (ev) {
                ev = ev || window.event;
                // 计算小方块定点坐标
                var x = ev.clientX - this.offsetLeft - _this.$filter.offsetWidth-_this.$filter.offsetWidth/2;
                var y = ev.clientY - this.offsetTop - _this.$filter.offsetHeight- _this.$filter.offsetHeight;
                // 获取小方块移动的最大坐标
